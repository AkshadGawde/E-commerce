    ...
    <div className='footer'>
      <div className='footerin1'>
        <div className='f1'>
          ...
          <p>Kanak is a leading online flour store in the Pune. We are committed to providing the best quality products at the best prices.</p>
      ...
      <div className='footerin2'>
        <h3>© Copyright 2023 DDtech, Inc.  All rights reserved</h3>
